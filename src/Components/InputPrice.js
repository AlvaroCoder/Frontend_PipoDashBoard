...
const CustomInput = React.forwardRef(function CustomInput(props, ref) {
    return(
        <InputUnstyled type='number'  slots={{input : StyledInputElement}} {...props} ref={ref}></InputUnstyled>
        )
});
...
export default function UnstyledSelectIntroduction() {
    ...
    const formatPrice = (price)=>{
        ...
        var match = numberPrice.match(/^\d+\.\d{0,2}$/)
        console.log(match);
        ...
        <div className='ctn-input-price'>
            ...
            <div className='ctn-input-money'>
                ...
                >
                    {
                        moneys.map((val)=>{
                            return <StyledOption value={val.nombre}>{val.icon}</StyledOption>
                        })
                    }
                </CustomSelect>
            </div>
